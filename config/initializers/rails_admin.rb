# RailsAdmin config file. Generated on November 02, 2013 16:24
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Coderbook', 'Admin']
  ...
  # config.excluded_models = ['Group', 'Post', 'Role', 'User', 'UserGroup', 'UserProfile']

  # Include specific models (exclude the others):
  # config.included_models = ['Group', 'Post', 'Role', 'User', 'UserGroup', 'UserProfile']
  ...
  #     configure :user_profile, :has_one_association 
  ...
  #     configure :id, :integer 
  #     configure :user_id, :integer         # Hidden 
  #     configure :profile_pic, :carrierwave 
  #     configure :hobbies, :text 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
